...
/**
 * Removes an object's prototype by setting it to `null` without mutating it.
 *
 * @param {object} someObject The object to remove the prototype of.
 * @returns {object} The object without the prototype.
 */
blimpy.withNoProto = function blimpyWithNoClass(someObject) {
    return blimpy.withProto(null, someObject);
}
